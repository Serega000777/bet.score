...
Репозиторий находится на этапе формирования технического фундамента. Текущая версия содержит документацию, границы архитектуры, каркасы API, веб-приложения и Telegram Mini App, локальную инфраструктуру и CI.
